	...
	public CheckInfo() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Field[] fields = CheckInfo.class.getDeclaredFields(); // 通过Java反射机制获得类中的所有属性
...
//				JTextField[] text = {textField, textField_1, textField_2};
//				for(JTextField jt: text) {
//					if(jt.getText().trim().length() == 0) {
//						String info = "请填写“" + jt.getName()
//						+ "”！";
//						JOptionPane.showMessageDialog(null, info,
//								"友情提示",
//								JOptionPane.INFORMATION_MESSAGE);
